...
describe('Proxy Generation', () => {
  describe('Packetstream', () => {
    ...
    it('Should generate rotating proxies for packetstream with 1 country', () => {
      ...
      result.forEach((proxy) => {
        expect(proxy).toEqual('testhost.killerproxies.com:1234:testuser:testpw-rot-country-us');
      });
    });
    ...
    it('Should generate sticky proxies for packetstream with 1 country', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.killerproxies.com:1234:testuser:testpw-sticky-country-us-session-.{7}/g;
    ...
    it('Should generate rotating proxies for packetstream with 1 country and ssl enabled', () => {
      ...
      result.forEach((proxy) => {
        expect(proxy).toEqual('http://testhost.killerproxies.com:1234:testuser:testpw-rot-country-us');
      });
    });
    ...
    it('Should generate rotating proxies for packetstream with multiple countries', () => {
      ...
      expect(result).toEqual([
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-us',
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-ca',
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-mx',
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-us',
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-ca',
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-mx',
        'testhost.killerproxies.com:1234:testuser:testpw-rot-country-us',
    ...
    it('Should generate sticky proxies for packetstream with multiple countries', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.killerproxies.com:1234:testuser:testpw-sticky-country-(us|ca|mx)-session-.{7}/g;
        expect(re.test(proxy)).toBeTruthy();
      });
    });
  });
  ...
  describe('Oxylabs', () => {
    it('Should generate rotating proxies for oxylabs with 1 country', () => {
      ...
      result.forEach((proxy) => {
        expect(proxy).toEqual('testhost.oxylabs.io:1234:testuser:testpw-country-us');
      });
    });
    ...
    it('Should generate rotating proxies for oxylabs with multiple countries', () => {
      ...
      expect(result).toEqual([
        'testhost.oxylabs.io:1234:testuser:testpw-country-us',
        'testhost.oxylabs.io:1234:testuser:testpw-country-ca',
        'testhost.oxylabs.io:1234:testuser:testpw-country-mx',
        'testhost.oxylabs.io:1234:testuser:testpw-country-us',
        'testhost.oxylabs.io:1234:testuser:testpw-country-ca',
        'testhost.oxylabs.io:1234:testuser:testpw-country-mx',
        'testhost.oxylabs.io:1234:testuser:testpw-country-us',
  ...
  describe('Smart', () => {
    it('Should generate rotating proxies for smart with 1 country', () => {
      ...
      result.forEach((proxy) => {
        expect(proxy).toEqual('testhost.smartproxy.com:1234:testuser:testpw-country-us');
      });
    });
    ...
    it('Should generate sticky proxies for smart with 1 country', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.smartproxy.com:1234:testuser:testpw-country-us_session-.{8}_lifetime-1h/g;
        expect(re.test(proxy)).toBeTruthy();
      });
    });
    ...
    it('Should generate sticky proxies for smart with 1 country and 30 minutes session duration', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.smartproxy.com:1234:testuser:testpw-country-us_session-.{8}_lifetime-30m/g;
        expect(re.test(proxy)).toBeTruthy();
      });
    });
    ...
    it('Should generate rotating proxies for smart with 1 country and city', () => {
      ...
      result.forEach((proxy) => {
        expect(proxy).toEqual('testhost.smartproxy.com:1234:testuser:testpw-country-us_city-new_york');
      });
    });
    ...
    it('Should generate sticky proxies for smart with 1 country and city', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.smartproxy.com:1234:testuser:testpw-country-us_city-new_york_session-.{8}_lifetime-1h/g;
        expect(re.test(proxy)).toBeTruthy();
      });
    });
    ...
    it('Should generate sticky proxies for smart with 1 country, city and 30 minutes session duration', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.smartproxy.com:1234:testuser:testpw-country-us_city-new_york_session-.{8}_lifetime-30m/g;
        expect(re.test(proxy)).toBeTruthy();
      });
    });
    ...
    it('Should generate rotating proxies for smart with country us and state', () => {
      ...
      result.forEach((proxy) => {
        expect(proxy).toEqual('testhost.smartproxy.com:1234:testuser:testpw-country-us_state-us_california');
      });
    });
    ...
    it('Should generate rotating proxies for smart with multiple countries', () => {
      ...
      expect(result).toEqual([
        'testhost.smartproxy.com:1234:testuser:testpw-country-us',
        'testhost.smartproxy.com:1234:testuser:testpw-country-ca',
        'testhost.smartproxy.com:1234:testuser:testpw-country-mx',
        'testhost.smartproxy.com:1234:testuser:testpw-country-us',
        'testhost.smartproxy.com:1234:testuser:testpw-country-ca',
        'testhost.smartproxy.com:1234:testuser:testpw-country-mx',
        'testhost.smartproxy.com:1234:testuser:testpw-country-us',
    ...
    it('Should generate sticky proxies for smart with multiple countries', () => {
      ...
      result.forEach((proxy) => {
        const re = /testhost.smartproxy.com:1234:testuser:testpw-country-(us|ca|mx)_session-.{8}_lifetime-1h/g;
        expect(re.test(proxy)).toBeTruthy();
      });
    });
  });
  ...
  describe('IPRoyal', () => {
    ...
    it('Should generate rotating proxies for iproyal with multiple countries', () => {
      ...
      expect(result).toEqual([
        'testhost.iproyal.com:12323:testuser:testpw-country-us',
        'testhost.iproyal.com:12323:testuser:testpw-country-ca',
        'testhost.iproyal.com:12323:testuser:testpw-country-mx',
        'testhost.iproyal.com:12323:testuser:testpw-country-us',
        'testhost.iproyal.com:12323:testuser:testpw-country-ca',
        'testhost.iproyal.com:12323:testuser:testpw-country-mx',
        'testhost.iproyal.com:12323:testuser:testpw-country-us',
