...
export const mixedfafoCountryRegions = {
  us: [
...
export const formatHostAndPort = (input: {
  ...
  const isEuCountry = mixedfafoCountryRegions.eu.find((rgn) => rgn.code.toLowerCase() === country);
  ...
  const isAsiaCountry = mixedfafoCountryRegions.asia.find((rgn) => rgn.code.toLowerCase() === country);
